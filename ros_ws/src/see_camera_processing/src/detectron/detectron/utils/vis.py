...
def vis_one_image(
    ...
    for i in sorted_inds:
        ...
        obj_class_str = get_class_string(classes[i], score, dataset).split(' ')[0]
        box_color = 'r'
        if obj_class_str == 'Yellow':
            box_color = '#00FF00'
        elif obj_class_str == 'Blue':
            box_color = '#0000FF'
        elif obj_class_str == 'Orange':
            box_color = '#FF2600'
        ...
        if show_class:
            ax.text(
                ...
                family='serif',
                bbox=dict(
                    facecolor=box_color, alpha=0.4, pad=0, edgecolor='none'),
                color='white')
