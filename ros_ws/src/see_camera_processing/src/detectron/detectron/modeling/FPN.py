...
HIGHEST_BACKBONE_LVL = 4  # E.g., "conv5"-like level
...
def add_fpn_ResNet50_conv3_body_cones_v1(model):
    return add_fpn_onto_conv_body(
        model, 
        ResNet.add_ResNet50_conv3_body, 
        fpn_level_info_ResNet50_cones_v1
    )

def add_fpn_ResNet50_conv4_body_cones_v1(model):
    return add_fpn_onto_conv_body(
        model, 
        ResNet.add_ResNet50_conv4_body, 
        fpn_level_info_ResNet50_conv4_cones_v1
    )
...
def fpn_level_info_ResNet50_cones_v1():
    return FpnLevelInfo(
...
def fpn_level_info_ResNet50_conv4_cones_v1():
    return FpnLevelInfo(
