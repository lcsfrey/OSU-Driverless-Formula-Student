...
from lib.layers.modules.focal_loss import FocalLoss
...
class MultiBoxLoss(nn.Module):
    ...
    def __init__(self, cfg, priors, use_gpu=True):
        ...
        self.loss_func = FocalLoss(cfg, priors) if cfg.USE_FOCAL_LOSS else F.cross_entropy
        self.priors = priors
    ...
    def forward(self, predictions, targets):
        ...
        loss_c = self.loss_func(conf_p, targets_weighted, size_average=False)
